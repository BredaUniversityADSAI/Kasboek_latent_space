...
#decrease_volume('output_rae_1.08.mp3', output_path='lower.mp3', dB=-10)

def overlay_audio(audio1='output_rae.mp3', audio2='output_ryan.mp3', output_name='output.mp3'):
...
overlay_audio(audio1='output_rae_0.92.mp3')